...
def write_combined_results(all_results, output_dir):
    ...
    combined_sig_df = pd.concat(combined_sig, ignore_index=True).sort_values("Adjusted P-value")
    ...
    combined_suggestive_df = pd.concat(combined_suggestive, ignore_index=True).sort_values("Adjusted P-value")
