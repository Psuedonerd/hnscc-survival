...
def load_modeling_dependencies():
    ...
    try:
        ...
        raise ImportError(
            "Model training dependencies are not installed in this Python "
            f"environment ({missing}). From the repository root, activate the "
            "project virtual environment and run `pip install -r requirements.txt`."
        ) from exc
